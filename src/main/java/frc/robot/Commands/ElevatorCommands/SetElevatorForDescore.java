...
public class SetElevatorForDescore extends Command {
  /** Creates a new SetElevatorForDescore. */
  public SetElevatorForDescore(ElevatorSubsystem mElevatorSubsystem) {
