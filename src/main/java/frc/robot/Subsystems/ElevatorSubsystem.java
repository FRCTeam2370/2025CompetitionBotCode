...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public static void configElevator(){
    ...
    elevatorConfiguration.Slot0.kP = 0.06;//0.06***** //needs more tunning with weight and maybe Motion Magic pls , 2.25
    elevatorConfiguration.Slot0.kI = 0.00155;//0.00155
    elevatorConfiguration.Slot0.kD = 0.00155;//0.00155
